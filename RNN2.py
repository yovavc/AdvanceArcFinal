...
class RNNAttention(nn.Module):
    def __init__(self, catagories):
        ...
        self.c1 = nn.Conv2d(128, 32, kernel_size1)
        ...
        self.c2 = nn.Conv2d(32, 16, kernel_size2)
        ...
        self.RNN1 = nn.LSTM(81, 64, 3, bidirectional=True, batch_first=True)
        self.RNN2 = nn.LSTM(32, 64, 2, bidirectional=True, batch_first=True)
